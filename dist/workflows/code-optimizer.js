...
export class CodeOptimizerWorkflow {
    ...
    pythonBinPath = '/Users/nithindeepkumar/Library/Python/3.10/bin';
    blackCmd = path.join(this.pythonBinPath, 'black');
    pylintCmd = path.join(this.pythonBinPath, 'pylint');
    constructor() {
